# Installation Guide for Unsigned Extensions
...
3. Mozilla reviews it (usually 1-2 weeks for first submission)
4. Once approved:
...
2. Upload your `.xpi` under "Submit a New Add-on"
3. Choose "On your own" (not listed on AMO)
4. Mozilla signs it and returns a signed `.xpi`
5. Distribute the signed version to users
